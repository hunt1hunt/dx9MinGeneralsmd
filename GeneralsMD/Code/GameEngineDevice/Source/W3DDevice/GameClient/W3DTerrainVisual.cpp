...
// ======================================================================
// ====================== ����ȷ������ԭ��ͷ�ļ� ======================
//#include "W3DAsset.h"       // �7�3 �޸���W3DAssetManager δ���壨��ʵͷ�ļ���
//#include "Terrain.h"        // �7�3 �޸���TheTerrainLogic δ��������ʵͷ�ļ���
// ==================================================================
...
//	 m_flatModelRenderObj = W3DDisplay::m_assetManager->Create_Render_Obj( "BloomBox_S" ); // BloomBox_D
 //  m_flatModelRenderObj = W3DDisplay::m_assetManager->Create_Render_Obj( "BLOOMBOX" ); 
        ...
        {  
            ...
            Real belowZ  = extent.lo.z - 50.0f;  // �ر���͵������� 50 ��λ  
            ...
            // ע�⣺�� Release_Ref����Ϊ������Ҫ����ָ���Ա� reset ʱ�Ƴ�  
        }  
        else  
        {  
	 ...
	 // ====================== ���� b.w3d�������ڶ���ģ�ͣ� ======================
      {    // �ͷ���һ�ο��ܲ����� b ����
        ...
        if( m_flatModelRenderObjB )
        {
            ...
            Real centerX = ( extent.lo.x + extent.hi.x ) * 0.5f;
            Real centerY = ( extent.lo.y + extent.hi.y ) * 0.5f;
            Real belowZ  = extent.lo.z - 0.0f;  // �� a ͬһ�߶ȣ��������޸�
...
//m_flatModelRenderObj = W3DDisplay::m_assetManager->Create_Render_Obj( "BloomBox_R" ); // BloomBox_D
        if( m_flatModelRenderObjC )
        {
           ...
           // Real belowZ  = extent.lo.z - 4.5f;  // �� a ͬһ�߶ȣ��������޸�
//Real belowZ  = extent.lo.z + 7.5f;  // �� a ͬһ�߶ȣ��������޸�
//Real belowZ  = extent.lo.z + 5.5f;  // �� a ͬһ�߶ȣ��������޸�
//Real belowZ  = extent.lo.z + 7.1f;  // �� a ͬһ�߶ȣ��������޸�
Real belowZ  = extent.lo.z + 7.0f;  // �� a ͬһ�߶ȣ��������޸�
