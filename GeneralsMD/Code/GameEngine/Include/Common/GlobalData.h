...
public:
	...
	Int m_sampleableZFormat;	///< VF-1c format: 0=auto (INTZ first, expert verdict 2026-09-19: D24S8/D24X8 have NO SRV in dgVoodoo; INTZ is the sampleable FOURCC), 1=D24X8, 2=D24S8 (fossil A/B), 3=force INTZ. INTZ = no stencil (behind-building markers / point-light volumes degrade; UseSampleableZBuffer=No restores)
	...
	Bool m_usePBRMaterials;		///< enable PBR materials for units/buildings (INI: UsePBRMaterials)
